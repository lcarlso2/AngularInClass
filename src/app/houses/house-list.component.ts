...
export class HouseListComponent{
  ...
  houses:House[] = [
      new House(1,"123 Maple st., Carrollton, GA 30118", "Beautiful House", 234000, new Date(),4,3.5,"7704567890","./assets/images/house1.jpeg"),
      new House(2,"234 Burge st., Carrollton, GA 30118", "Ugly House", 123000, new Date(),4,3.5,"4567891232","./assets/images/house2.jpeg"),
      new House(3,"345 Dood st., Carrollton, GA 30118", "Amazing House", 45600, new Date(),4,3.5,"7894561231","./assets/images/house3.jpeg"),
      new House(4,"890 Bomb st., Carrollton, GA 30118", "Ehhh House", 999999, new Date(),4,3.5,"3451236786","./assets/images/house4.jpeg"),
      new House(5,"678 Burge st., Carrollton, GA 30118", "Mehh House", 665778, new Date(),4,3.5,"7706754564","./assets/images/house5.jpeg"),
